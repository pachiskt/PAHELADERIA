<%@ Page Title="Gestión de Métodos de Pago" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MetodoPago.aspx.cs" Inherits="Heladeria_CRUD.MetodoPago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="cliente-container">
        <h1 class="cliente-title">Gestión de Métodos de Pago</h1>
        
        <!-- Sección de Listado -->
        <div class="section">
            <h3>Listado de Métodos de Pago</h3>
            <div class="button-group">
                <asp:Button ID="btnListar" runat="server" Text="Listar Métodos de Pago" OnClick="btnListar_Click" CssClass="rounded-button primary-button" />
            </div>
        </div>
        
        <!-- Sección de Agregar/Actualizar -->
        <div class="section">
            <h3>Agregar / Actualizar Método de Pago</h3>
            <asp:Label ID="lblMensaje" runat="server" CssClass="message-label" />
            
            <div class="input-group">
                <label for="txtId">ID Método:</label>
            ...
            <div class="button-group">
                <asp:Button ID="btnAgregar" runat="server" Text="Agregar Método" OnClick="btnAgregar_Click" CssClass="rounded-button primary-button" />
                <asp:Button ID="btnActualizar" runat="server" Text="Actualizar Método" OnClick="btnActualizar_Click" CssClass="rounded-button secondary-button" />
            </div>
        </div>
        
        <!-- Sección de Búsqueda -->
        <div class="section">
            <h3>Buscar Método de Pago</h3>
        ...
        <div class="section">
            ...
            <div class="input-group">
                <label for="txtEliminar">ID Método:</label>
                <asp:TextBox ID="txtEliminar" runat="server" CssClass="rounded-input" />
            </div>
            
            <div class="button-group">
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar Método" OnClick="btnEliminar_Click" CssClass="rounded-button danger-button" />
            </div>
        </div>
        
        <!-- GridView para mostrar resultados -->
        <div class="grid-container">
            <asp:GridView ID="gvMetodoPago" runat="server" AutoGenerateColumns="true" 
