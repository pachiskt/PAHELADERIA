<%@ Page Title="Gestión de Sabores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sabor.aspx.cs" Inherits="Heladeria_CRUD.Sabor1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="cliente-container">
        <h1 class="cliente-title">Gestión de Sabores</h1>
        
        <!-- Sección de Listado -->
        <div class="section">
            <h3>Listado de Sabores</h3>
            <div class="button-group">
                <asp:Button ID="btnListar" runat="server" Text="Listar Sabores" OnClick="btnListar_Click" CssClass="rounded-button primary-button" />
            </div>
        </div>
        
        <!-- Sección de Agregar/Actualizar -->
        <div class="section">
            <h3>Agregar / Actualizar Sabor</h3>
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="rounded-input" />
            </div>
            
            <div class="input-group">
                <label for="txtCategoriaId">Categoría ID:</label>
                <asp:TextBox ID="txtCategoriaId" runat="server" CssClass="rounded-input" />
            </div>
            
            <div class="input-group">
                <label for="chkPopular">¿Es Popular?:</label>
            ...
            <div class="button-group">
                <asp:Button ID="btnAgregar" runat="server" Text="Agregar Sabor" OnClick="btnAgregar_Click" CssClass="rounded-button primary-button" />
                <asp:Button ID="btnActualizar" runat="server" Text="Actualizar Sabor" OnClick="btnActualizar_Click" CssClass="rounded-button secondary-button" />
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="input-group">
                ...
                <asp:DropDownList ID="ddlCriterio" runat="server" CssClass="rounded-input">
                    <asp:ListItem Value="sabor_id">ID</asp:ListItem>
                    <asp:ListItem Value="nombre">Nombre</asp:ListItem>
                    <asp:ListItem Value="categoria">Categoría</asp:ListItem>
                    <asp:ListItem Value="popular">¿Es Popular?</asp:ListItem>
                </asp:DropDownList>
            </div>
        ...
        <div class="grid-container">
            <asp:GridView ID="gvSabores" runat="server" AutoGenerateColumns="true" 
